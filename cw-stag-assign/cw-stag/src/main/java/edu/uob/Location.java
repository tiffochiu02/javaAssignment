...
//        this.description = "";
    ...
    public void addArtefact(Artefact artefact){
        int maxIndex = 0;
        for(Map.Entry<Integer,Artefact> entry : this.artefacts.entrySet()){
    ...
    public void addPath(int index, String toName){this.paths.put(index,toName);}
    ...
    public String listAllArtefacts(){
        ...
        for(int i = 0; i<this.artefacts.size()-1; i++){
            String name = this.artefacts.get(i).getName();
            names.append(name).append(", ");
        }
        names.append(this.artefacts.get(this.artefacts.size()-1).getName());
    ...
    public String listAllFurniture(){
        ...
        names.append(this.furniture.get(this.furniture.size()-1).getName());
        return names.toString();
    }
}
